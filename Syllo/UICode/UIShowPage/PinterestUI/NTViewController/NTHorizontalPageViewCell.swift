...
class NTHorizontalPageViewCell : UICollectionViewCell, UITableViewDelegate, UITableViewDataSource{
    ...
    let tableView = UITableView(frame: CGRectMake(0, 0, screenWidth, screenHeight - statubarHeight - navigationHeaderAndStatusbarHeight), style: UITableViewStyle.Plain)
